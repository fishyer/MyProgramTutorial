- 来源：[Python-3-教程](https://www.runoob.com/python3/python3-tutorial.html)
- [Python3-教程](https://www.runoob.com/python3/python3-tutorial.html)
- [Python3-简介](https://www.runoob.compython3-intro.html)
- [Python3-环境搭建](https://www.runoob.compython3-install.html)
- [Python3-VScode](https://www.runoob.compython-vscode-setup.html)
- [Python3-基础语法](https://www.runoob.compython3-basic-syntax.html)
- [Python3-基本数据类型](https://www.runoob.compython3-data-type.html)
- [Python3--数据类型转换](https://www.runoob.compython3-type-conversion.html)
- [Python3-推导式](https://www.runoob.compython-comprehensions.html)
...
- [Python3-运算符](https://www.runoob.compython3-basic-operators.html)
...
- [Python3-元组](https://www.runoob.compython3-tuple.html)
- [Python3-字典](https://www.runoob.compython3-dictionary.html)
- [Python3-集合](https://www.runoob.compython3-set.html)
- [Python3-编程第一步](https://www.runoob.com/python3/python3-step1.html)
...
- [Python3-迭代器与生成器](https://www.runoob.compython3-iterator-generator.html)
...
- [Python3-File](https://www.runoob.compython3-file-methods.html)
- [Python3-OS](https://www.runoob.compython3-os-file-methods.html)
...
- [Python3-命名空间/作用域](https://www.runoob.com/python3/python3-namespace-scope.html)
...
- [Python-MySQL---mysql-connector-驱动](https://www.runoob.compython-mysql-connector.html)
...
- [Python3-urllib](https://www.runoob.compython-urllib.html)
...
- [Python3-operator-模块](https://www.runoob.com/python3/python-operator.html)
...
- [Python-random-模块](https://www.runoob.com/python3/python-random.html)
